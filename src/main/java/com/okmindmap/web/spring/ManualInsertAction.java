...
public class ManualInsertAction extends BaseAction {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try{
			...
			if(multipartFile != null){
		        ...
		        result = noticeService.insertManual(title, content, user.getId(), targetDbFilePath);
		        
			}else{
				
				result = noticeService.insertManual(title, content, user.getId(), "");
