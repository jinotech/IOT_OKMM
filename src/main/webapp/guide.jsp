...
// 				setInterval(resize, 2000);
			...
			// 가이드 리스트 가저오기			
			function getGuideMapList(){ 				
			
            	$.ajax({
    				type: 'post',
    				dataType: 'html',
    				async: false,
    				url: '${pageContext.request.contextPath}/getGuideMapList.do',
					success: function(data) {
    					
    					$("#__guideList__").html(data);
    					
    				},
    				error: function(request, data, status, err) {
