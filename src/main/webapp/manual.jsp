...
// 				setInterval(resize, 2000);
			...
			function getNoticeList(page){
            	...
            	$.ajax({
    				...
    				dataType: 'html',
    				async: false,
    				url: '${pageContext.request.contextPath}/manualList.do',
			...
			function goNoticeView(id){
				...
				window.location.href = "${pageContext.request.contextPath}/manualWrite.do?id="+id+"&page="+page+"&searchKeyword="+keyword;
				</c:if>
				<c:if test="${user.auth ne 'admin' }"> 
				window.location.href = "${pageContext.request.contextPath}/manualView.do?id="+id+"&page="+page+"&searchKeyword="+keyword;
				</c:if>
			}
			...
			function goNoticeWrite(){
				window.location.href = "${pageContext.request.contextPath}/manualWrite.do";
			}
