...
<div class="dialog_title"><spring:message code='user.find_username'/></div>

<div style="padding-left:60px; padding-top:20px;">
<table class="user-new" width="100%" border="0" cellspacing="0" cellpadding="0">
<form id="frm_recover" action="${pageContext.request.contextPath}/user/findusername.do" method="post"  onSubmit="return checkSubmit(this);">
