...
<div class="ok-lnb">
    ...
    <div class="lnb-logo">
        <img src="./images/logo.png" alt="okmainmpa" />
    </div>
    <ul>
        <li class="on">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <th>내용</th>
                <td>
                    ${data.notice.content_ko }
                </td>
            </tr>
        </tbody>
    </table>
    <div class="btn-area">
    	<!-- <input type="button" class="btn point" value="저장" onclick="saveNotice();" /> -->
        <input type="button" class="btn gray" value="목록" onclick="goNotice();" />
        <!-- <input type="button" class="btn br" value="삭제" /> -->
    </div>
</div>
<!---------------------------------- 컨텐츠 영역 -------------------------------------->
