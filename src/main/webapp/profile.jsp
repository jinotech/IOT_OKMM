...
// 				setInterval(resize, 2000);
			...
			function saveProfile(gb){
				...
				if(gb == "1"){
					...
					dt = {'firstname' : firstname, 'username' : username, 'email' : email, 'self' : self, 'gb' : '1'};
				}else if(gb == "2"){
					...
					dt = {'oldpw' : oldpw, 'newpw1' : newpw1, 'newpw2' : newpw2, 'gb' : '2'};
				}
				...
				$.ajax({
	   				...
	   				dataType: 'json',
	   				async: false,
	   				url: '${pageContext.request.contextPath}/profileUpdate.do',
	   				data: dt,
...
<!---------------------------------- 컨텐츠 영역 -------------------------------------->
    <div class="contents">
        <ul class="tab-area tab-event">
            <li class="on" data-target=".box01">
                <a href="#">개인정보상세</a>
            </li>
            <li data-target=".box02">
                <a href="#">비밀번호</a>
            </li>
            <li data-target=".box03">
                <a href="#">활동</a>
            </li>
        </ul>
        ...
        <div class="target-data">
            <!-- 개인정보 상세 -->
            <div class="profile box01 on">
                <label for="usr-nm">이름</label>
                <input type="text" id="firstname" name="firstname" value="${user.firstname }" />
                <label for="usr-id">ID</label>
                <input type="text" id="username" name="username" value="${user.username }" />
                <label for="usr-email">email</label>
                <input type="text" id="email" name="email" value="${user.email }" />
                <label for="usr-intro">자기소개</label>
                <textarea id="self" rows="5" name="self">${user.self }</textarea>
                <input type="button" class="btn point" value="변경내용 저장" onclick="saveProfile('1');" />
            </div>
            <!-- 개인정보 상세 -->
            <!-- 비밀번호 -->
            <div class="profile box02">
                <label for="usr-pw">기존암호</label>
                <input type="password" id="oldpw" value="" />
                <label for="usr-pw02">새비밀번호</label>
                <input type="password" id="newpw1" name="newpw1" value="" />
                <label for="usr-pw03">새비밀번호확인</label>
                <input type="password" id="newpw2" name="newpw2" value="" />
                <input type="button" class="btn point" value="변경내용 저장" onclick="saveProfile('2');" />
            </div>
            <!-- 비밀번호 -->
            <!-- 활동 -->
            <div class="box03">
                <div class="txt-area">※ 마인드맵의 활동 기록은 3개월 데이터만 저장 됩니다.</div>
                <table class="table">
                    <colgroup>
                        <col width="20%" />
                        <col width="/" />
                    ...
                    <tbody>
                        <tr>
                            <th>2018.07.18   AM 11:30</th>
                            <td class="text-left">"마인드맵 테스트_신규" 신규 맵 등록</td>
                        </tr>
                        <tr>
                            <th>2018.07.18   AM 11:30</th>
                            <td class="text-left">"마인드맵 테스트" “테스트" 마디 추가 </td>
                        </tr>
                        <tr>
                            <th>2018.07.18   AM 11:30</th>
                            <td class="text-left">"마인드맵 테스트" “테스트" 마디 추가</td>
                ...
                <input type="button" class="btn point more w100" value="더보기" />
            </div>
            <!-- 활동 -->
        </div>
    </div>
